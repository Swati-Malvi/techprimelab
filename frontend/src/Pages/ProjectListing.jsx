...
const ProjectListing = () => {
  ...
  return (
    <Box
      ...
      gap={{ sm: "0px", base: "0px", md: "2px", lg: "2px", xl: "2px" }}
    ...
    >
      {screenSize.width > 640 ? (
        <SideBar
          prop1={""}
          prop2={""}
          prop3={"5px solid #1b5cbf"}
          prop4={"20px"}
          prop5={""}
          prop6={""}
          src1={process.env.PUBLIC_URL + "/images/Dashboard.jpg"}
          src2={process.env.PUBLIC_URL + "/images/Project-list-active.jpg"}
          src3={process.env.PUBLIC_URL + "/images/create-project.jpg"}
        />
      ) : null}
      <Box>
        <TopBar
        ...
        <Box
          ...
          top={{ sm: "0px", md: "12%", base: "0px", lg: "20%", xl: "20%" }}
          left={{ sm: "0px", md: "9%", base: "0px", lg: "6.2%", xl: "6.2%" }}
          backgroundColor={{
            sm: "transparent",
            md: "white",
            base: "transparent",
          ...
          boxShadow={{
            sm: "0",
            base: "0",
            md: "rgba(0, 0, 0, 0.1) 0px 0px 5px 0px, rgba(0, 0, 0, 0.1) 0px 0px 1px 0px",
        ...
        >
          <Box
            display={"flex"}
            p={{
              sm: "20px 5px 10px 5px",
              base: "20px 5px 10px 5px",
              md: "20px 20px 10px 20px",
              lg: "20px 20px 10px 20px",
              xl: "20px 20px 10px 20px",
            }}
            justifyContent={"space-between"}
            width={"100%"}
            mt={{ sm: "20px", base: "20px", md: "0px", lg: "0px", xl: "0px" }}
          >
            <Box
              display={"flex"}
              gap={"5px"}
                ...
                <Drawer placement={placement} onClose={onClose} isOpen={isOpen}>
                  ...
                  <DrawerContent>
                    ...
                    <DrawerBody lineHeight={"2.5"}>
                      <div id="priority" onClick={(e) => handleSelect(e)}>
                        Priority
                      </div>
                      <div id="category" onClick={(e) => handleSelect(e)}>
                        Category
                      </div>
                      <div id="location" onClick={(e) => handleSelect(e)}>
                        Location
                      </div>
                      <div id="division" onClick={(e) => handleSelect(e)}>
                        Division
                      </div>
                      <div id="department" onClick={(e) => handleSelect(e)}>
                        Department
                      </div>
                      <div id="reason" onClick={(e) => handleSelect(e)}>
                        Reason
                      </div>
                      <div id="status" onClick={(e) => handleSelect(e)}>
                        Status
                      </div>
                    </DrawerBody>
                  </DrawerContent>
