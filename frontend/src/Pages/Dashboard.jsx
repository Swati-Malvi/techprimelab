    ...
    >
      {screenSize.width > 640 ? (
        <SideBar
          ...
          prop5={""}
          prop6={""}
          src1={process.env.PUBLIC_URL + "/images/Dashboard-active.jpg"}
      ...
      <Box mb={"80px"}>
        ...
        <Box
          ...
          left={{ sm: "0px", md: "6.8%", base: "0px", lg: "5%", xl: "5%" }}
        >
          {screenSize.width > 640 ? (
        ...
        <Text
          fontSize={"22px"}
          fontWeight={"500"}
          mt={{ sm: "10px", base: "10px", md: "70px", lg: "50px", xl: "50px" }}
          textAlign={"start"}
          p={"20px"}
        >
        ...
        <Box
          ...
          ml={{ sm: "0px", base: "0px", md: "20px", lg: "20px", xl: "20px" }}
          p={{
            sm: "0px 5px",
            md: "0px 5px",
            base: "0px 5px",
