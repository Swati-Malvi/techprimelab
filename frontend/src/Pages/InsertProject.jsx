    ...
    >
      ...
      <Box>
        ...
        <Box
          ...
          m={"auto"}
          mt={{ sm: "30px", md: "0px", base: "30px", lg: "0px", xl: "0px" }}
          ...
          top={{ sm: "0px", md: "12.5%", base: "0px", lg: "20%", xl: "20%" }}
          backgroundColor={"white"}
          left={{ sm: "0px", md: "9.2%", base: "0px", lg: "6.5%", xl: "6.5%" }}
          ...
          <form>
            ...
            >
              <Box width={"100%"} textAlign={"start"}>
                ...
                />
                {formData.theme === "" ? (
                  <Text color={"red"}>Theme required</Text>
                ) : null}
              </Box>
              ...
              {screenSize.width > 640 ? (
                <Button
                  borderRadius={"50px"}
                  p={"0px 40px"}
                  backgroundColor={"#1b5cbf"}
                  color={"lightgray"}
                  _hover={{ backgroundColor: "#1b5cbf", color: "lightgray" }}
